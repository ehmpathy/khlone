...
class SiteManifest extends DomainLiteral<SiteManifest> {}
```
...
| Clone | Zone | lives in |
| Clone | SiteManifest.crew.roles | role resolved from |
| Clone | SiteManifest.crew.brains | brain resolved from |
