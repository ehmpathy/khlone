...
| severity | sense |
|----------|---------|
| 🔴 **blocker** | cannot ship without resolution |
| 🟠 **major** | significant risk or absent spec |
| 🟡 **minor** | polish or edge case |

---

## gap.1: BrainCli interface assumes subprocess model 🟠
...
## gap.2: session ID generation and collision 🟠
...
## gap.3: stream event schema translation 🟠
...
## gap.5: checkpoint restoration accuracy 🟠
...
## gap.8: rate limiter state persistence 🟡
...
## gap.10: daemon spawn race condition 🟡
...
## gap.16: brain output sanitization 🟡
...
## gap.17: cross-site daemon coordination 🟠
...
## gap.18: brain authentication state 🟠
...
## gap.19: task cancellation state 🟡
...
## gap.20: daemon socket permissions 🟡
...
| gap | severity | area |
|-----|----------|------|
| gap.1 | 🟠 major | BrainCli assumes subprocess model |
| gap.2 | 🟠 major | session ID generation and collision |
| gap.3 | 🟠 major | stream event schema translation |
| gap.4 | 🟠 major | PTY spawn failure modes |
| gap.5 | 🟠 major | checkpoint restoration accuracy |
| gap.6 | 🟡 minor | JSON-RPC error handle |
| gap.7 | 🟡 minor | onStop hook failure |
| gap.8 | 🟡 minor | rate limiter state persistence |
| gap.9 | 🟡 minor | brain adapter discovery |
| gap.10 | 🟡 minor | daemon spawn race condition |
| gap.11 | 🟡 minor | watch mode cleanup |
| gap.12 | 🟡 minor | skill prompt expansion |
| gap.13 | 🟡 minor | PTY buffer overflow |
| gap.14 | 🟡 minor | session cleanup |
| gap.15 | 🟡 minor | concurrent task limit |
| gap.16 | 🟡 minor | brain output sanitization |
| gap.17 | 🟠 major | cross-site daemon coordination |
| gap.18 | 🟠 major | brain authentication state |
| gap.19 | 🟡 minor | task cancellation state |
| gap.20 | 🟡 minor | daemon socket permissions |
